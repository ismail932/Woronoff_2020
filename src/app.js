...
Ammo().then((Ammo) => {
  ...
  function loadFloydText() {
    ...
    text_loader.load('./src/jsm/Roboto_Regular.json', function (font) {
      ...
      var geometry = new THREE.TextGeometry('Ism@il', {
        font: font,
        size: 3,
        height: 0.5,
        curveSegments: 12,
  ...
  function start() {
    ...
    createBox(19, 2, -70, 4, 4, 1, boxTexture.mail, 'mailto:arfloyd7@gmail.com', 0x000000, false);
    ...
    createBox(27, 2, -70, 4, 4, 1, boxTexture.writing, URL.devTo, 0x000000, false);

    // floatingLabel(3.875, 4.5, -70, 'Twitter');
    floatingLabel(11.875, 4.5, -70, 'Github');
    //floatingLabel(19.125, 4.5, -70, 'Twitter');
    floatingLabel(19.125, 4.5, -70, 'Email');
    // floatingLabel(35, 6.5, -70, '  Static \nWebsite');
    floatingLabel(26.875, 4.5, -70, '   How I made this?');
